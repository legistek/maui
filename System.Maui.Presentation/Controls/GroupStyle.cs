...
using System.Maui.Presentation.Data;      // CollectionViewGroup
...
namespace System.Maui.Presentation.Controls
{
	...
	public class GroupStyle : INotifyPropertyChanged
	{
		...
		static GroupStyle()
		{
			ItemsPanelTemplate template = new ItemsPanelTemplate(typeof(StackLayout));
			//template.Seal();
			DefaultGroupPanel = template;
			DefaultStackPanel = template;

			template = new ItemsPanelTemplate(typeof(VirtualizingStackPanel));
			//template.Seal();
