...
namespace System.Maui.Presentation.Controls.Primitives
{
	...
	public interface IItemContainerGenerator
	{
		...
		/// </summary>
		ItemContainerGenerator GetItemContainerGeneratorForPanel(Layout panel);
		...
		/// a previous call to StartAt.
		/// </remarks>
		BindableObject GenerateNext(out bool isNewlyRealized);
		...
		/// </param>
		void PrepareItemContainer(BindableObject container);
