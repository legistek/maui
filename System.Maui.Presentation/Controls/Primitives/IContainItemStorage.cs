...
namespace System.Maui.Presentation.Controls.Primitives
{
	...
	public interface IContainItemStorage
	{
		...
		void StoreItemValue(object item, BindableProperty dp, object value);
		...
		/// <param name="dp"></param>
		/// <returns></returns>
		object ReadItemValue(object item, BindableProperty dp);
